...
public class Hlong implements ByteArrayValueMapper {

    private static Log log = LogFactory.getLog(Hlong.class);
    /**
        ...
        try {
            ...
            log.warn(
                    String.format("Error mapping byte value %s to %s", Bytes.toStringBinary(input),
                            long.class.getName()), e);
            return ImmutableList.of();
        }
    }

    private long mapInternal(String toString) {
