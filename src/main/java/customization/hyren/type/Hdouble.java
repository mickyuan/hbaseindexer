...
public class Hdouble implements ByteArrayValueMapper {

    private static Log log = LogFactory.getLog(Hdouble.class);
    /**
        ...
        try {
            ...
            log.warn(
                    String.format("Error mapping byte value %s to %s", Bytes.toStringBinary(input),
                            double.class.getName()), e);
            return ImmutableList.of();
        }
    }

    private double mapInternal(String toString) {
